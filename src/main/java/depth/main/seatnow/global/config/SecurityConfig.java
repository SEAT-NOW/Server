    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/v1/stores/operation").hasRole("OWNER")
                        .requestMatchers(HttpMethod.PATCH,"/api/v1/stores/operation/images").hasRole("OWNER")
                        .requestMatchers(HttpMethod.GET,"/api/v1/stores/operation/images").hasRole("OWNER")
                        ...
                        .requestMatchers(HttpMethod.PATCH,"/api/v1/stores/menus/order").hasRole("OWNER")
                        .requestMatchers(HttpMethod.DELETE,"/api/v1/stores/menus/{menuId}").hasRole("OWNER")
